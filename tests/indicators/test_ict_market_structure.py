...
class TestIdentifySwingHighs:
    ...
    def test_no_swing_highs_in_uptrend(self):
        ...
        candles = [
            create_test_candle(i, 100 + i, 101 + i, 99 + i, 100.5 + i)
            for i in range(15)
        ]
    ...
    def test_multiple_swing_highs(self):
        ...
        candles = [
            create_test_candle(i, 100 + (i % 6) * 2, 101 + (i % 6) * 2,
                             99 + (i % 6) * 2, 100 + (i % 6) * 2)
            for i in range(20)
        ]
...
class TestDetectBOS:
    ...
    def test_no_bos_in_consolidation(self):
        ...
        candles = [
            create_test_candle(i, 100, 102, 98, 100 + (i % 2))
            for i in range(20)
        ]
...
class TestDetectCHoCH:
    ...
    def test_bullish_choch_downtrend_reversal(self):
        ...
        bullish_choch = [c for c in choch_events if c.direction == 'bullish']
