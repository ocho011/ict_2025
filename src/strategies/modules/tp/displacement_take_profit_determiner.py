"""ICT displacement-based Take Profit Determiner module."""
...
class DisplacementTakeProfitDeterminer(TakeProfitDeterminer):
    """
    ...
    @classmethod
    def from_validated_params(cls, params: "DisplacementTakeProfitDeterminer.ParamSchema") -> "DisplacementTakeProfitDeterminer":
        """Create instance from Pydantic-validated params."""
        return cls(**params.model_dump())

    risk_reward_ratio: float = 2.0
    fallback_risk_percent: float = 0.02
